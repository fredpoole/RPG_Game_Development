...
/*:
 * @plugindesc v0.61 - STV_MonsterCards
 ...
 * @parent Functions
 * @type number
 * @desc Set the max number of Cards that complete a Deck.
 * @default 10
 *
 * @param Found All Cards Switch
 * @parent Functions
 * @type switch
 * @desc Set a switch TRUE if all cards revealed.
 * @default 10
 *
 * @param Window
 *
 ...
 * @param Unknown Color
 * @parent Window
 * @desc The default color for "Unknown Data".
 * @default 7
 *
 * @param Back Bars Color
 * @parent Window
 * @desc The default color for all Back Bars.
 * @default 15
 * 
 * @param Text
 *
 * @param All Cards Text
 * @parent Text
 * @type text
 * @desc The default text for "All Cards".
 * @default All Cards
 *
 * @param Deck Text
 * @parent Text
 * @type text
 * @desc The default text for "Deck".
 * @default Deck
 *
 * @param Exit Text
 * @parent Text
 * @type text
 * @desc The default text for "Exit".
 * @default Exit
 *
 * @param Add Text
 * @parent Text
 * @type text
 * @desc The default text for "Add".
 * @default Add
 *
 * @param Remove Text
 * @parent Text
 * @type text
 * @desc The default text for "Remove".
 * @default Remove
 *
 * @param Unknown Data
 * @parent Text
 ...
 * @default ???
 *
 * @param Series Headline
 * @parent Text
 * @type text
 * @desc The default Headline for "Series".
 * @default Series:
 *
 * @param Rarity Headline
 * @parent Text
 * @type text
 * @desc The default Headline for "Rarity".
 * @default Rarity:
 *
 * @param First Found Headline
 * @parent Text
 * @type text
 * @desc The default Headline for "First Found At".
 * @default First found at:
 *
 * @param Card Points Headline
 * @parent Text
 * @type text
 * @desc The default Headline for "Card Points".
 * @default Card Points:
 *
 * @param Card Settings
 *
 * @param Card Back Picture
 * @parent Card Settings
 * @desc The Card Back Picture in img/cards/
 * @default monster_back
 *
 * @param Rarity 0
 * @parent Card Settings
 * @desc Rarity name and color for type 0
 * (separate by ",": NAME,COLOR) (Normal,0)
 * @default Normal,0
 *
 * @param Rarity 1
 * @parent Card Settings
 * @desc Rarity name and color for type 1
 * (separate by ",": NAME,COLOR) (Rare,3)
 * @default Rare,3
 *
 * @param Rarity 2
 * @parent Card Settings
 * @desc Rarity name and color for type 2
 * (separate by ",": NAME,COLOR) (Epic,1)
 * @default Epic,1
 *
 * @param Rarity 3
 * @parent Card Settings
 * @desc Rarity name and color for type 3
 * (separate by ",": NAME,COLOR) (Relikt,14)
 * @default Relikt,14
 *
 * @param Series 1 Icon
 * @parent Card Settings
 * @desc The Icon for Series 1
 * @default 89
 *
 * @param Series 2 Icon
 * @parent Card Settings
 ...
 * @param New Card Text
 * @parent ShowCards
 * @desc Default Text for New Card
 * @default NEW
 *
 * @param New Card Icon
 * @parent ShowCards
 * @desc Default Icon for New Card
 * @default 163
 *
 * @param Show Card Command
 * @parent ShowCards
 * @desc Default Text for Show Card Command
 * @default Nice!
 *
 * @param Sound
 * @parent ShowCards
 ...
 * @param ME Name
 * @parent Sound
 * @desc The file name of the ME under audio/me.
 * Leave empty for no ME.
 * @default Victory1
 *
 * @param ME Volume
 * @parent Sound
 ...
 *
 * Update v0.6
 * - Added basic functions/script calls
 *
 * Update v0.61
 ...
 * ////////////////////////////////////////////////////////////////////////////
 *
 * There are the following Type of Cards:
 *
 * All Cards.           # All Cards that are there.
 * Player Cards         # Cards the player has inside Inventory, but not in Deck.
 * Player Deck          # Cards the player has inside his Deck, but not Inventory.
 *
 * All Commands like give, giveBooster, remove, clear or complete
 * will add/remove Cards to "Player Cards" but not to the "Player Deck".
 *
 * To add specific Cards to his Deck, the player has to use MonsterCards Manager.
 *
 * For Example:
 * You want to trade with someone. He wants Card 9 from you and offers Card 16:
 * 
 * - Check if player has the Card ->        $monsterCards.isAtPlayer(9);
 * - Remove Card from player ->             $monsterCards.remove(9);
 * - Give player his new Card ->            $monsterCards.give(16);
 *
 * $monsterCards.hasCard(7);                <- This Command will Check if
 *                                          Card 7 is inside Players Cards OR
 *                                          inside Players Deck.
 *
 * 
 * ////////////////////////////////////////////////////////////////////////////
 ...
 * Plugin Command:
 * 
 *   MonsterCards manager           # Open the Monster Cards Scene.
 ...
 *   MonsterCards giveBooster 1 3   # Gives BoosterPack with 3 random Cards
 *                                    out of Series 1.
 *   MonsterCards giveBooster 0 5   # Gives BoosterPack with 5 random Cards
 *                                    out of all Series/Cards.
 *
 * Script Calls:
 *
 ...
 * ////////////////////////////////////////////////////////////////////////////
 * 
 * Create BoosterPack Item:
 * 1. - Create an Item which is only useable on menuscreen and on "effects"
 *      choose "other" -> "Common Event" (for example common event 1);
 * 2. - Inside Common Event 1 call the Plugin Command "MonsterCards giveBooster 2 5"
 * 3. - When you are using this Item you will gain 5 random Cards from Series 2.
 * 4. - Done :)
 * 
 */
